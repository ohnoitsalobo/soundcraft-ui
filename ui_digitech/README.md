...
My attempt to build a basic HTML page that can control Ch 1 and 2 of the Soundcraft Ui mixers - including specifically the Digitech amp modeling parameters.
